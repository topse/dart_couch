...
class AttachmentInfoMapper extends ClassMapperBase<AttachmentInfo> {
  ...
  static String? _$encoding(AttachmentInfo v) => v.encoding;
  static const Field<AttachmentInfo, String> _f$encoding = Field(
    'encoding',
    _$encoding,
    opt: true,
  );
  ...
  @override
  final MappingHook hook = const AttachmentInfoRawHook();
